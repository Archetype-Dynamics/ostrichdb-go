...
func CreateCollection(c *lib.Collection) error {
	...
	path:= lib.PathBuilder(lib.QUERY_PARAM_NONE, pName, colName)
...
func ListCollections(p *lib.Project) error {
	...
	path:= lib.PathBuilder(lib.QUERY_PARAM_NONE, pName)
...
func RenameCollection(c *lib.Collection, new string) error {
	...
	path:= lib.PathBuilder(lib.QUERY_PARAM_RENAME, pName, colName, new)
